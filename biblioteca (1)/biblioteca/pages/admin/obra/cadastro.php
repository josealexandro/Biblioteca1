               ...
               <div class="col" > 
                  ...
                  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                     ...
                     <div class="form-group" >
                        ...
                        <input value="<?=$editMode ? htmlspecialchars($obra['ano']) : ""?>" type="text" class="form-control" name="ano" id="ano" maxlength="4" required>
                     </div>


                     <div class="form-group" >
                        <label for="capa" >Capa</label>
                        <input type="file" class="form-control" name="capa" id="capa" accept=".jpg,.jpeg,.png,.bmp,.gif"><br/>
