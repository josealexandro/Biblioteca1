...
if (isset($_POST["deletar"])) {
   deletarObraAction($_POST["cod_obra"]);
}
                        ...
                        <tr>
                           ...
                           <td width=140px>
                              <form action="<?=htmlspecialchars($_SERVER["PHP_SELF"])?>" method="POST" >
                                 <div class="btn-group">
                                    <a href='detalhes.php?id=<?=$row['cod_obra']?>' class="btn btn-outline-secondary">
                                    ...
                                    <a href='cadastro.php?id=<?=$row['cod_obra']?>' class="btn btn-outline-secondary">
                                    ...
                                    <button type="submit" class="btn btn-outline-danger" name="deletar" id="deletar" onclick="return confirm('Deseja mesmo excluir o registro?');">
                                       <input type="hidden" name="cod_obra" id="cod_obra" value="<?=$row['cod_obra']?>" />
