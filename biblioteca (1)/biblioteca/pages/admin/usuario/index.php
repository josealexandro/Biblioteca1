...
if (isset($_POST["deletar"])) {
   deletarUsuarioAction($_POST["cod_usuario"]);
}
                        ...
                        <tr>
                           ...
                           <td width=140px>
                              <form action="<?=htmlspecialchars($_SERVER["PHP_SELF"])?>" method="POST" >
                                 <div class="btn-group">
                                    <a href='detalhes.php?id=<?=$row['cod_usuario']?>' class="btn btn-outline-secondary">
                                    ...
                                    <a href='cadastro.php?id=<?=$row['cod_usuario']?>' class="btn btn-outline-secondary">
                                    ...
                                    <button type="submit" class="btn btn-outline-danger" name="deletar" id="deletar" onclick="return confirm('Deseja mesmo excluir o registro?');">
                                       <input type="hidden" name="cod_usuario" id="cod_usuario" value="<?=$row['cod_usuario']?>" />
